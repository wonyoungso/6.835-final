...
json = JSON.parse(File.read('./cities_geo_final.json'), symbolize_names: false)


json["features"].each do |f|
  
  cityName = f["properties"]["name"] + " " + state_abbr[f["properties"]["state"]] 
...
File.open("cities_geo_final_02.json", 'w') { |file| file.write(json.to_json) }
